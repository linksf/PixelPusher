...
const ToolIcon = styled(FontAwesomeIcon)`
    ...
    cursor: pointer;
    color: ${props => props.isactive ? props.palette[props.index] : "#ecf0f1"};
...
const ToolPicker = ({name, icon}) => {
    ...
    return (
        <ToolIcon icon={icon} palette={palette} index={currentColorIndex} isactive={tool === name ? 1 : 0} onClick={handleClick} />
    )
}
